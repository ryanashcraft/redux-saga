  ...
  function runEffect(effect, effectId, currCb) {
    ...
    **/
    if (is.promise(effect)) {
      ...
      if (type === __chunk_2.TAKE) runTakeEffect(payload, currCb)
      else if (type === __chunk_2.PUT) runPutEffect(payload, currCb)
      else if (type === __chunk_2.ALL) runAllEffect(payload, effectId, currCb)
      else if (type === __chunk_2.RACE) runRaceEffect(payload, effectId, currCb)
      else if (type === __chunk_2.CALL) runCallEffect(payload, effectId, currCb)
      else if (type === __chunk_2.CPS) runCPSEffect(payload, currCb)
      else if (type === __chunk_2.FORK) runForkEffect(payload, effectId, currCb)
      else if (type === __chunk_2.JOIN) runJoinEffect(payload, currCb)
      else if (type === __chunk_2.CANCEL) runCancelEffect(payload, currCb)
      else if (type === __chunk_2.SELECT) runSelectEffect(payload, currCb)
      else if (type === __chunk_2.ACTION_CHANNEL) runChannelEffect(payload, currCb)
      else if (type === __chunk_2.FLUSH) runFlushEffect(payload, currCb)
      else if (type === __chunk_2.CANCELLED) runCancelledEffect(payload, currCb)
      else if (type === __chunk_2.GET_CONTEXT) runGetContextEffect(payload, currCb)
      else if (type === __chunk_2.SET_CONTEXT) runSetContextEffect(payload, currCb)
      else currCb(effect)
    } else {
